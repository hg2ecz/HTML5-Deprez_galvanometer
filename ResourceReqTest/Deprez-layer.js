...
class Deprez {
  constructor(figure, unit, minvalue, maxvalue, scalastep, scalatick) {
    this.minvalue = minvalue;
    this.maxvalue = maxvalue;

    var element=document.getElementById(figure+"-bg");
    ...
    var element=document.getElementById(figure+"-fg");
    this.c=element.getContext("2d");
  }
