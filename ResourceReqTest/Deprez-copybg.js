...
class Deprez {
  constructor(figure, minvalue, maxvalue, scalastep, scalatick, unit) {
    ...
    this.c.closePath();
    this.c.restore();
    this.bgimageData = this.c.getImageData(0,0,this.width,this.height);
  }

  paint(value) {
    this.c.putImageData(this.bgimageData, 0, 0);

    this.c.save();
    var radian = (120*value/(this.maxvalue-this.minvalue))/180*Math.PI;
